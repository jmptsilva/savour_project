<footer class="text-center bg-[#161616] text-white mx-auto">
    <div class="container px-6 pt-6 w-screen">
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-2">
            <div class="mb-6">
                ...
                <ul class="list-none mb-0">
                    ...
                    <li>
                        <a href="#!" class="text-white">123, rue Fake Street</a>
                    </li>
                    <li>
                        <a href="#!" class="text-white">Belval, Luxembourg</a>
                    </li>
                    <li>
                        <a href="#!" class="text-white">Phone number +352 78 76 74</a>
                    </li>
                </ul>
            </div>

            <div class="mb-6">
                <h5 class="uppercase font-bold mb-2.5">Advertise</h5>
            ...
            <div class="mb-6">
                <h5 class="uppercase font-bold mb-2.5">Community</h5>
            ...
            <div class="mb-6">
                <h5 class="uppercase font-bold mb-2.5">Savour Apps</h5>

                <ul class="list-none mb-0">
                    <li>
                        <a href="#!" class="text-white">Google Play</a>
                    </li>
                    <li>
                        <a href="#!" class="text-white">App Store</a>
                    </li>
