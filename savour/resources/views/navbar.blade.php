...
<nav class="bg-[#161616] shadow-lg sticky top-0 w-screen z-10">
        ...
        <div class="flex justify-between">
            <div class="flex space-x-7">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="{{route('welcome')}}" class="py-4 px-2 text-white border-b-4 border-[#d49a3d] font-semibold ">Home</a>
                    <a href="{{route('menu')}}" class="py-4 px-2 text-white font-semibold hover:text-[#d49a3d] transition duration-300">Menu</a>
                    <a href="{{route('contact')}}" class="py-4 px-2 text-white font-semibold hover:text-[#d49a3d] transition duration-300">Contact</a>
                    <a href="{{route('about')}}" class="py-4 px-2 text-white font-semibold hover:text-[#d49a3d] transition duration-300">About
                        Us</a>
                </div>
            </div>
    ...
    <div class="hidden mobile-menu">
        <ul class="">
            <li class="active"><a href="{{route('welcome')}}" class="block text-sm px-2 py-4 text-white bg-[#d49a3d] font-semibold">Home</a></li>
