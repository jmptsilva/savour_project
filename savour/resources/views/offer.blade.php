                    ...
                    <div class="flex flex-col items-center rounded-lg shadow-lg bg-white m-4">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-baseline">
                                <h5 class="_foodName w-[100px] text-ellipsis whitespace-nowrap text-gray-900 text-2xl font-medium mb-2">${offer.name}</h5>
                                <p class="_price text-red-500 text-3xl">$${offer.price}</p>
                            </div>
