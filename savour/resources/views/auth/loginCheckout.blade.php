        ...
        <div class=" flex justify-around items-center mt-10 ml-2">
            ...
            <div class="flex flex-row-reverse">
                <div class="flex flex-col ml-3 mt-20">
                    ...
                    <button data-modal-toggle="cashPayment" type="button" class="text-white bg-black hover:bg-slate-500 focus:ring-4 focus:ring-[#d49a3d] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#d49a3d] mr-2 mb-2">
                    ...
                    <button type="button" class="text-white bg-black hover:bg-slate-500 focus:ring-4 focus:ring-[#d49a3d] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#d49a3d] mr-2 mb-2">
                ...
                <div class="w-[300px]">
                    <div class="mt-4">
                        ...
                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#d49a3d]" id="inline-full-name" type="text" value="">
                    </div>
                    <div class="mt-4">
                        <label class=" text-white font-bold md:text-right mb-1 md:mb-0 pr-4" for="card_number">
                            Card Number
                        </label>
                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#d49a3d]" id="inline-full-name" type="text" value="" placeholder="0000 0000 0000 0000">
                    </div>
                    <div class="mt-4 flex gap-5 ">
                        <div>
                            ...
                            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#d49a3d]" id="inline-full-name" type="text" value="" placeholder="mm/yy">
                        </div>
                        <div>
                            <label class=" text-white font-bold md:text-right mb-1 md:mb-0 pr-4" for="cvvnumber">
                                CVV
                            </label>
                            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#d49a3d]" id="inline-full-name" type="text" value="" placeholder="000">
                        </div>
                    </div>
